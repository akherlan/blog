...
Pengujian ini termasuk analisis uji kecocokan sebaran, yaitu *the goodness of fittest test* ([oppo iku?](https://www.google.com/search?safe=strict&source=hp&ei=VTpqXb2MGJzAz7sPt8mR6Ao&q=the+goodness+of+fit+test)). Dipakai untuk menguji kecocokan distribusi frekuensi sampel data terhadap fungsi distribusi peluang yang diperkirakan dapat menggambarkan atau mewakili distribusi frekuensi tersebut (rumitnya bahasa copas).

Gampangnya? Kenapa ada uji Chi-Kuadrat ($\chi^2$)?
...
Analisis bisa diterima kalau nilai Chi-Kuadrat yang kita hitung kurang dari Chi-Kuadrat Kritis ($\chi_{h}^2 < \chi_{cr}^2$). Nilai kritis itu diperoleh dari tabel.
...
Setelah ditentukan batas-batas dan interval data, sekarang kita bisa mendefinisikan data ke dalam masing-masing kelompoknya, yang ada enam itu.
...
Ketika membandingkan $\chi_{h}^2$ dengan $\chi_{cr}^2$ sesungguhnya saya mengalami kebingunan. Ada dua versi.

### Versi pertama^[Dari pernyataan dalam halaman web [Sciencing.com](https://sciencing.com/info-8027315-degrees-freedom-chisquare-test.html) bagian *Calculating*.]
...
1. untuk distribusi normal & binomial ($P = 2$)
2. untuk distribusi gumbel & poisson ($P = 1$)
...
Data hujan bisa diterima karena nilai Chi-Kuadrat hitung $\chi_{h}^2 = 5.9474$ kurang dari nilai kritis $\chi_{cr}^2 = 7.815$ (tingkat kepercayaan 0.05 untuk distribusi normal).
...
![Menghitung uji Chi-Square di worksheet](/post/2019-08-31-uji-chi-kuadrat-pada-data-hujan_files/chi-square-excel.png)
